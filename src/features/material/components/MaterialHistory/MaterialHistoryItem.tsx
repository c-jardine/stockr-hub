...
import { type MaterialGetHistoryOutput } from "../../../../types/material";
...
function renderTitle(event: MaterialGetHistoryOutput[0], stockUnit: StockUnit) {
...
export default function MaterialHistoryItem({
  history,
  stockUnit,
  createdAt,
}: {
  history: MaterialGetHistoryOutput;
  stockUnit: StockUnit;
  createdAt: Date;
}) {
  return (
